        ...
        <CardContent className="pt-6">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Choose the loan program that best fits your needs and start the application process. 
              You can complete all required information during the application flow.
            </p>
