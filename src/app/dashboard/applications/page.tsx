  ...
  return (
    <div className="space-y-6 p-4 md:p-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="font-headline text-3xl font-bold">Available Loan Programs</h1>
          <p className="text-muted-foreground">Choose from our comprehensive selection of financing solutions</p>
        </div>
        <Button asChild>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{loanPrograms.length}</div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Equipment financing</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Longest Terms</CardTitle>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between pt-2">
                          ...
                          <Button size="sm" asChild>
                            <Link href={`/dashboard/application/${program.id}`}>
        ...
        <CardContent className="pt-6">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Choose the loan program that best fits your needs and start your application today. 
              Our team is ready to help you navigate the process and get the financing you need.
            </p>
