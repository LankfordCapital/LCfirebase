    ...
    <div>
      <section className="relative bg-primary/5 py-20 md:py-28 text-center">
        <div className="container mx-auto px-4">
          <h1 className="font-headline text-4xl font-bold text-primary md:text-5xl">Industrial Acquisition & Bridge Loans</h1>
        ...
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-16 items-center">
          <div>
           ...
           <div className="relative h-96 w-full rounded-lg overflow-hidden shadow-lg">
             <Image src="https://placehold.co/600x400.png" alt="A large industrial facility" layout="fill" objectFit="cover" data-ai-hint="industrial facility" />
          </div>
        </div>
      </section>
