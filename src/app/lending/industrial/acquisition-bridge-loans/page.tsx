  ...
  return (
    <div>
      <section className="relative h-[50vh] flex items-center justify-center text-white py-20 md:py-28">
        ...
        >
          <source src="https://firebasestorage.googleapis.com/v0/b/lankford-lending.firebasestorage.app/o/shutterstock_1100153923.mp4?alt=media&token=3bc642d6-276a-40a1-9900-9a164e5c2b0d" type="video/mp4" />
        </video>
        <div className="absolute top-0 left-0 w-full h-full bg-black/50 z-10" />
        <div className="container relative z-20 mx-auto px-4 text-center">
          <h1 className="font-headline text-4xl font-bold md:text-5xl"><span className="text-white">Industrial Acquisition</span><span className="text-primary"> & Bridge Loans</span></h1>
          <p className="mt-4 max-w-2xl mx-auto text-lg text-white/90">
            Seize industrial opportunities with fast and flexible short-term financing.
          </p>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div>
            <h2 className="font-headline text-3xl font-bold"><span className="text-primary">Move Quickly and</span> <span className="text-black">Confidenty</span></h2>
            <p className="mt-4 text-lg text-foreground/70">
                In the fast-paced world of industrial real estate, speed is critical. Our acquisition and bridge loans provide the short-term capital needed to acquire properties quickly, execute on a business plan, or bridge a gap until permanent financing is secured for your warehouse, factory, or distribution center.
            </p>
