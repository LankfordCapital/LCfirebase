...
export default async function WorkforceOfficepage5Page({ params }: { params: Promise<{ program: string }> }) {
    ...
    return (
        <Suspense fallback={<Page5Skeleton />}>
            <LoanApplicationClientPage5 loanProgram={loanProgram} officeContext="workforce" />
        </Suspense>
    )
}
