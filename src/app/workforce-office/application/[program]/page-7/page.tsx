...
export default async function WorkforceOfficepage7Page({ params }: { params: Promise<{ program: string }> }) {
    ...
    return (
        <Suspense fallback={<Page7Skeleton />}>
            <LoanApplicationClientPage7 loanProgram={loanProgram} officeContext="workforce" />
        </Suspense>
    )
}
