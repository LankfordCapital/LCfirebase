      ...
      <section className="relative bg-primary/5 py-20 md:py-32">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mt-6 max-w-3xl mx-auto text-lg text-foreground/80 md:text-xl">
            Lankford Lending provides tailored, innovative financing solutions to power your real estate and business ambitions.
      ...
      <section className="bg-primary/5 py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-headline text-3xl font-bold text-primary md:text-4xl">Why Partner with Lankford Lending?</h2>
