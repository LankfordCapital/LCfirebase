// Residential NOO (Non-Owner Occupied) Loan Application Types
// This file defines the complete data structure for Residential NOO loan applications only

import { Timestamp } from 'firebase/firestore';

// ============================================================================
// RESIDENTIAL NOO LOAN PROGRAMS
// ============================================================================

export type ResidentialNOOProgram = 
...
// ============================================================================
// BORROWER INFORMATION (Residential NOO Specific)
// ============================================================================
...
// ============================================================================
// FINANCIAL INFORMATION (Residential NOO Specific)
// ============================================================================
...
// ============================================================================
// LOAN SPECIFIC INFORMATION (Residential NOO Specific)
// ============================================================================
...
// ============================================================================
// PROPERTY INFORMATION (Residential NOO Specific)
// ============================================================================

export interface PropertyInformation {
  // Basic Property Details
  propertyType: 'single_family' | 'multi_family' | 'condo' | 'townhouse';
  propertyUse: 'investment' | 'construction';
  ...
  // Multi-unit specific information
  units?: Array<{
    id: string;
...
export interface GroundUpConstructionInfo {
...
export interface FixAndFlipInfo {
...
// ============================================================================
// DOCUMENT TRACKING (Residential NOO Specific)
// ============================================================================
...
// ============================================================================
// MAIN RESIDENTIAL NOO LOAN APPLICATION INTERFACE
// ============================================================================

export interface ResidentialNOOLoanApplication {
  id?: string;
...
export interface ApplicationSummary {
  id: string;
  borrowerName: string;
  loanProgram: ResidentialNOOProgram;
  loanAmount: number;
  status: ApplicationStatus;
  createdAt: Timestamp;
  lastUpdated: Timestamp;
